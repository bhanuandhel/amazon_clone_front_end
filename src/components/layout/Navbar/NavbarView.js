                        ...
                        <div className="input-group">
                            <div className="input-group-prepend">
                                <div className="dropdown">
                                    ...
                                    <div className={`dropdown-menu ${rtl}`} aria-labelledby="btnCategoryDropdownMenu">
                                        <a className="dropdown-item" href="#" onClick={(e) => {props.handleCatChange(e, 0)}}>{t('navbar.productCategory.all')}</a>
                                        <a className="dropdown-item" href="#" onClick={(e) => {props.handleCatChange(e, 1)}}>{t('navbar.productCategory.smartphone')}</a>
                                        <a className="dropdown-item" href="#" onClick={(e) => {props.handleCatChange(e, 2)}}>{t('navbar.productCategory.kitchen_hardware')}</a>
                                        <a className="dropdown-item" href="#" onClick={(e) => {props.handleCatChange(e, 3)}}>{t('navbar.productCategory.prime_deal')}</a>
                                        <a className="dropdown-item" href="#" onClick={(e) => {props.handleCatChange(e, 4)}}>{t('navbar.productCategory.book')}</a>
                                    </div>
                                </div>
                            </div>
                            <input type="text" className={`form-control ${rtl}`} size="50" name="query" id="query" onChange={props.handleQueryChange} value={props.query} />
                            ...
                            <div className="dropdown-menu" aria-labelledby="prefLanguageDropdown">
                                <form className="p-3">
                                    ...
                                    <div className="custom-control custom-radio mb-2">
                                        <input className="custom-control-input" type="radio" name="prefLang" id="englishLang" defaultValue="en" onClick={props.handleChangelang}
                                            defaultChecked={props.prefLang=='en'?true:false} />
                                    ...
                                    <div className="dropdown-divider"></div>
                                    <div className="custom-control custom-radio mb-2">
                                        <input className="custom-control-input" type="radio" name="prefLang" id="hindiLang" defaultValue="in"  onClick={props.handleChangelang}
                                        defaultChecked={props.prefLang=='in'?true:false}  />
                                    ...
                                    <div className="dropdown-divider"></div>
                                    <div className="custom-control custom-radio mb-2">
                                        <input className="custom-control-input" type="radio" name="prefLang" id="urduLang" defaultValue="pk"  onClick={props.handleChangelang} 
                                        defaultChecked={props.prefLang=='pk'?true:false} />
                                    ...
                                    <div className="custom-control custom-radio">
                                        <input className="custom-control-input" type="radio" name="prefLang" id="banglaLang" defaultValue="bd"  onClick={props.handleChangelang} defaultChecked={props.prefLang=='bd'?true:false}  />
